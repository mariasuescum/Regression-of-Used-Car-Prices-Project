...
models = [
    ...
    "A3 2.0T",
    "A3 2.0T Premium",
    "A3 2.0T Tech Premium",
    "A4 2.0T Premium",
    "A4 2.0T Premium Plus",
    "A4 2.0T Premium Plus quattro",
    "A4 2.0T Premium quattro",
    "A4 2.0T Tech Premium",
    "A4 2.0T Titanium Premium",
    "A4 3.2 Premium Plus quattro",
    "A5 2.0T Premium",
    "A5 2.0T Premium Plus",
    "A5 2.0T Prestige",
    "A5 45 S line Premium Plus",
    "A5 Sportback S line Premium Plus",
    "A6 2.0T Premium Plus",
    "A6 2.0T Sport",
    "A6 3.0 TDI Premium Plus",
    ...
    "AMG E 53 4MATIC",
    "AMG E 53 Base 4MATIC",
    "AMG E 63 S 4MATIC",
    "AMG G 63 4MATIC",
    "AMG G 63 Base",
    "AMG G AMG G 63 4MATIC",
    "AMG GL AMG GL 63 4MATIC",
    "AMG GLA 45 Base 4MATIC",
    "AMG GLC 43 AMG GLC 43",
    "AMG GLC 63 Base 4MATIC",
    "AMG GLE 43 4MATIC Coupe",
    "AMG GLE 43 Coupe 4MATIC",
    "AMG GLE 53 AMG GLE 53",
    ...
    "Arnage R",
    "Arteon 2.0T SE",
    "Arteon 2.0T SEL Premium R-Line",
    "Arteon 2.0T SEL R-Line",
    "Arteon SEL R-Line",
    "Ascent Limited 7-Passenger",
    "Ascent Touring 7-Passenger",
    "Atlas 3.6L SE w/Technology",
    "Atlas 3.6L SEL Premium",
    "Atlas 3.6L SEL Premium R-Line",
    "Atlas Cross Sport 3.6L V6 SEL Premium",
    "Avalanche 1500 LS",
    "Avalanche 1500 LT",
    "Avalanche 1500 LTZ",
    "Avalanche LTZ",
    ...
    "Bronco",
    "Bronco Badlands",
    "Bronco Badlands Advanced",
    "Bronco Base",
    "Bronco Big Bend",
    "Bronco Big Bend Advanced",
    "Bronco Heritage Edition Advanced",
    "Bronco Outer Banks",
    "Bronco Outer Banks Advanced",
    "Bronco Raptor",
    "Bronco Sport Base",
    "Bronco Sport Big Bend",
    "Bronco Sport Outer Banks",
    "Bronco Wildtrak Advanced",
    "Bronco XLT",
    "C-Class 4MATIC Sedan",
    "C-Class C 250 Luxury",
    "C-Class C 250 Sport",
    "C-Class C 300",
    "C-Class C 300 4MATIC",
    "C-Class C 300 4MATIC Luxury",
    "C-Class C 300 4MATIC Sport",
    "C-Class C 300 Luxury",
    "C-Class C 63 AMG",
    "C-Class C280 4MATIC",
    "C-Class C300 4MATIC",
    "C-Class C55 AMG Sport",
    "C-HR LE",
    "C-Max Energi SE",
    "C30 T5 Premier Plus",
    "C40 Recharge Pure Electric Twin Ultimate",
    "C70 T5",
    "CC 2.0T Sport",
    "CC Sport",
    "CLA-Class CLA 250",
    "CLK-Class 500 Cabriolet",
    "CLK-Class 550",
    "CLK-Class CLK 350",
    "CLS 450 Base",
    "CLS-Class CLS 400 4MATIC",
    "CLS-Class CLS 550",
    "CLS-Class CLS 63 AMG S-Model 4MATIC",
    "CLS-Class CLS500",
    "CR-V EX",
    "CR-V EX-L",
    "CR-V LX",
    ...
    "CT5-V V-Series",
    "CT6 Luxury",
    "CT6-V 4.2L Blackwing Twin Turbo",
    "CTS 2.0L Turbo Luxury",
    "CTS 3.6L Luxury",
    "CTS 3.6L Premium",
    "CTS 3.6L Premium Luxury",
    "CTS Base",
    "CTS Luxury",
    "CTS Performance",
    "CTS Premium",
    "CTS-V Base",
    "CX-30 2.5 S Select Package",
    "CX-30 Base",
    "CX-30 Preferred",
    "CX-30 Premium Package",
    "CX-30 Select",
    "CX-5 Grand Touring",
    "CX-5 Touring",
    ...
    "Cayenne Diesel",
    "Cayenne E-Hybrid S",
    "Cayenne E-Hybrid S Platinum Edition",
    "Cayenne GTS",
    "Cayenne GTS Coupe AWD",
    ...
    "Corvette Stingray w/1LT",
    "Corvette Stingray w/2LT",
    "Corvette Stingray w/3LT",
    "Corvette Z06",
    "Corvette Z06 w/2LZ",
    "Corvette ZR-1",
    "Countryman Cooper",
    ...
    "E-Class D 2.5 Turbo",
    "E-Class E 300",
    "E-Class E 300 4MATIC",
    "E-Class E 350",
    "E-Class E 350 4MATIC",
    "E-Class E 400",
    "E-Class E 400 4MATIC",
    "E-Class E 450 4MATIC",
    "E-Class E 550",
    "E-Class E 550 4MATIC",
    "E-Class E500",
    "E-Class E55 AMG",
    "E-PACE 300 Sport",
    "E-PACE S",
    ...
    "Escalade ESV Premium Luxury Platinum",
    "Escalade ESV Sport",
    "Escalade EXT Base",
    "Escalade Luxury",
    "Escalade Platinum",
    ...
    "Express 1500 Base",
    "Express 1500 Cargo",
    "Express 1500 Work Van",
    "Express 2500 Work Van",
    "Express 3500 Base",
    "Express 3500 LT",
    "F-150 FX4",
    "F-150 Heritage XL SuperCab Flareside",
    "F-150 Lariat",
    ...
    "F-250 Platinum",
    "F-250 XL",
    "F-250 XL Crew Cab Super Duty",
    "F-250 XL SuperCab H/D",
    "F-250 XLT",
    "F-250 XLT Crew Cab Super Duty",
    "F-250 XLT Super Duty",
    "F-250 XLT SuperCab Super Duty",
    "F-350 King Ranch",
    "F-350 Lariat",
    "F-350 Lariat Crew Cab Super Duty DRW",
    "F-350 Lariat Super Duty Crew Cab",
    "F-350 Platinum",
    "F-350 XL",
    "F-350 XLT",
    "F-PACE 25t Premium",
    ...
    "GL-Class GL 550",
    "GL-Class GL 550 4MATIC",
    "GLA 250 Base 4MATIC",
    "GLA-Class GLA 250 4MATIC",
    "GLA-Class GLA 45 AMG",
    "GLB 250 Base 4MATIC",
    "GLC 300 Base",
    "GLC 300 Base 4MATIC",
    "GLC 300 GLC 300",
    ...
    "Genesis Coupe 3.8 Grand Touring",
    ...
    "Golf GTI 2.0T Autobahn 4-Door",
    "Golf GTI 2.0T S 4-Door",
    "Golf GTI 2.0T SE 4-Door",
    "Golf GTI 2.0T SE w/Performance Package 4-Door",
    "Golf R 20th Anniversary Edition",
    "Golf R 4-Door",
    "Golf R 4-Door w/DCC & Navigation",
    "Golf R Base",
    "Golf SportWagen TSI S 4-Door",
    ...
    "Impreza WRX STI",
    "Impreza WRX Sti",
    "Impreza WRX Sti Special Edition",
    "Insight EX",
    "Integra GS-R",
    "Integra LS",
    ...
    "MDX 3.5L w/Technology Package",
    "MDX 3.7L Advance",
    "MDX Sport",
    "MDX Sport Hybrid 3.0L w/Technology Package",
    "MDX Technology",
    "MDX Touring",
    ...
    "Maybach S S 600",
    "Mazda3 FWD w/Preferred Package",
    "Mazda3 FWD w/Premium Package",
    ...
    "Niro Plug-In Hybrid EX Premium",
    "Odyssey EX-L",
    "Odyssey Elite",
    "Odyssey LX",
    "Optima EX",
    ...
    "Outback Touring XT",
    "Outlander SEL",
    "Outlander Sport 2.4 SE",
    "Outlander Sport ES",
    "Pacifica Hybrid Touring L",
    "Pacifica Launch Edition",
    "Pacifica Touring",
    ...
    "ProMaster 2500 Window Van High Roof",
    "ProMaster 3500 High Roof",
    "ProMaster 3500 Tradesman",
    "Protege DX",
    "Prowler Base",
    "Q3 2.0T Premium Plus",
    "Q3 45 S line Premium",
    "Q3 45 S line Premium Plus",
    "Q3 S line Premium Plus",
    "Q4 e-tron 50 Premium Plus",
    "Q4 e-tron Sportback Premium",
    "Q40 Base",
    "Q5 2.0T Premium",
    "Q5 2.0T Premium Plus",
    "Q5 3.0 TDI Premium Plus",
    "Q5 3.0T Premium Plus",
    "Q5 40 Premium",
    "Q5 Premium",
    "Q5 S line Premium",
    "Q5 S line Premium Plus",
    "Q50 3.0T Premium",
    "Q50 3.0t Red Sport 400",
    "Q50 3.0t Signature Edition",
    "Q50 Hybrid Premium",
    "Q50 Hybrid Sport",
    "Q50 Premium",
    "Q60 3.0T Premium",
    "Q60 3.0t Red Sport 400",
    "Q7 3.0T Premium",
    ...
    "RS 5 4.2",
    "RS 7 4.0T",
    "RS 7 4.0T Performance Prestige",
    "RS 7 4.0T Prestige",
    "RS 7 4.0T quattro",
    "RS Q8 4.0T",
    "RS Q8 4.0T quattro",
    ...
    "RX 330 Base",
    "RX 350 Base",
    "RX 350 Crafted Line F Sport",
    "RX 350 F SPORT Appearance",
    "RX 350 F Sport",
    "RX 350 F Sport Performance",
    "RX 350 RX 350",
    "RX 350 RX 350 F SPORT Handling",
    "RX 450h Base",
    ...
    "Routan SE",
    "Rover Defender",
    "Rover Defender 110 SE",
    "Rover Defender S",
    "Rover Defender SE",
    "Rover Defender V8",
    "Rover Defender X",
    "Rover Defender X-Dynamic SE",
    "Rover Discovery HSE",
    "Rover Discovery HSE LUXURY",
    "Rover Discovery LSE",
    "Rover Discovery S",
    "Rover Discovery SE",
    "Rover Discovery Sport HSE",
    "Rover Discovery Sport S R-Dynamic",
    "Rover Discovery Sport SE",
    "Rover Discovery Sport SE R-Dynamic",
    "Rover LR2 Base",
    "Rover LR2 HSE",
    "Rover LR3 HSE",
    "Rover LR4 HSE",
    "Rover LR4 HSE LUX Landmark Edition",
    "Rover LR4 Lux",
    "Rover Range Rover 3.0L Supercharged",
    "Rover Range Rover 3.0L Supercharged HSE",
    "Rover Range Rover 3.0L V6 Supercharged HSE",
    "Rover Range Rover 5.0L Supercharged",
    "Rover Range Rover 5.0L Supercharged Autobiography",
    "Rover Range Rover 5.0L Supercharged Autobiography LWB",
    "Rover Range Rover 5.0L V8 Supercharged",
    "Rover Range Rover Autobiography",
    "Rover Range Rover Evoque Base",
    "Rover Range Rover Evoque HSE Dynamic",
    "Rover Range Rover Evoque Pure",
    "Rover Range Rover Evoque R-Dynamic HSE",
    "Rover Range Rover Evoque S",
    "Rover Range Rover Evoque SE",
    "Rover Range Rover Evoque SE Premium",
    "Rover Range Rover HSE",
    "Rover Range Rover HSE SWB",
    "Rover Range Rover P400 SE LWB 7 Seat",
    "Rover Range Rover P400 SE SWB",
    ...
    "Rover Range Rover SV Autobiography Dynamic SWB",
    "Rover Range Rover SWB",
    "Rover Range Rover Sport 3.0 Supercharged HST",
    "Rover Range Rover Sport 3.0L Supercharged HSE",
    "Rover Range Rover Sport 5.0L Supercharged Dynamic",
    "Rover Range Rover Sport First Edition",
    "Rover Range Rover Sport HSE",
    "Rover Range Rover Sport HSE Dynamic",
    "Rover Range Rover Sport HST MHEV",
    "Rover Range Rover Sport P400 SE Dynamic",
    "Rover Range Rover Sport SE MHEV",
    "Rover Range Rover Sport SVR",
    "Rover Range Rover Sport SVR Carbon Edition",
    "Rover Range Rover Sport Supercharged",
    "Rover Range Rover Sport Supercharged Dynamic",
    "Rover Range Rover Sport Supercharged HSE",
    "Rover Range Rover Supercharged",
    "Rover Range Rover Supercharged LWB",
    "Rover Range Rover Velar P250 S R-Dynamic",
    "Rover Range Rover Velar P250 SE R-Dynamic",
    "Rover Range Rover Velar P380 S",
    "Rover Range Rover Velar P380 SE R-Dynamic",
    "Rover Range Rover Velar R-Dynamic S",
    "Rover Range Rover Velar R-Dynamic SE",
    "Rover Range Rover Velar SVAutobiography Dynamic Edition",
    "Rover Range Rover Westminster SWB",
    "S-10 LS",
    "S-10 LS Crew Cab",
    "S-Class S 450",
    "S-Class S 450 4MATIC",
    "S-Class S 550",
    "S-Class S 550 4MATIC",
    "S-Class S 560",
    ...
    "S5 4.2 Premium Plus",
    "S6 4.0T",
    "S6 4.0T Premium Plus",
    "S6 4.0T Prestige",
    "S60 B5 Inscription",
    "S60 R",
    "S60 Recharge Plug-In Hybrid T8 Inscription",
    "S60 T5 Premier Plus",
    "S60 T6 Momentum",
    "S7 2.9T Prestige",
    "S7 4.0T Premium Plus",
    "S8 4.0T Plus",
    "S8 4.0T quattro",
    "S8 4.2 quattro",
    "S80 3.2",
    ...
    "SL-Class SL63 AMG Roadster",
    "SLC 300 Base",
    "SLK-Class SLK 250",
    "SLK-Class SLK 350",
    "SLK-Class SLK230 Kompressor",
    "SLK-Class SLK280 Roadster",
    "SLK-Class SLK320",
    "SLS AMG Base",
    "SQ5 3.0T Premium",
    ...
    "STS V6",
    "SX4 Base",
    "Santa Cruz 2.5T Limited",
    "Santa Fe GLS",
    "Santa Fe SE",
    "Santa Fe SEL",
    "Santa Fe SEL Plus 2.4",
    "Santa Fe Sport 2.0L Turbo",
    "Santa Fe Sport 2.0L Turbo Ultimate",
    ...
    "Sienna LE",
    "Sienna XLE Limited",
    "Sienna XSE 25th Anniversary",
    "Sierra 1500 AT4",
    "Sierra 1500 Denali",
    "Sierra 1500 Denali Ultimate",
    "Sierra 1500 Limited Elevation",
    ...
    "Sierra 2500 Denali",
    "Sierra 2500 SLE",
    "Sierra 2500 SLE H/D Extended Cab",
    "Sierra 3500 Denali",
    "Sierra 3500 SLE",
    "Silverado 1500 1LT",
    "Silverado 1500 1LZ",
    ...
    "Silverado 1500 Hybrid 1HY",
    "Silverado 1500 LS",
    "Silverado 1500 LT",
    "Silverado 1500 LT Crew Cab",
    "Silverado 1500 LT Extended Cab",
    "Silverado 1500 LT Trail Boss",
    "Silverado 1500 LTZ",
    "Silverado 1500 Limited Custom",
    "Silverado 1500 Limited High Country",
    "Silverado 1500 Limited LT Trail Boss",
    "Silverado 1500 RST",
    "Silverado 1500 W/T",
    "Silverado 1500 Z71 Extended Cab",
    "Silverado 1500 ZR2",
    "Silverado 2500 H/D",
    "Silverado 2500 High Country",
    "Silverado 2500 LT",
    "Silverado 2500 LT H/D Extended Cab",
    "Silverado 2500 LTZ",
    "Silverado 2500 LTZ H/D Extended Cab",
    "Silverado 2500 WT",
    ...
    "Sportage X-Pro",
    "Sprinter 2500",
    "Sprinter 2500 High Roof",
    "Sprinter 2500 Standard Roof",
    "Sprinter 3500 High Roof",
    "Sprinter 3500XD High Roof",
    "Sprinter 4500 High Roof",
    "Sprinter High Roof",
    ...
    "TT 2.0T",
    "TT 2.0T Premium",
    "TT 3.2 Cabriolet quattro",
    "TT RS 2.5T",
    "TT RS Base",
    "TT Roadster quattro",
    "TTS 2.0T Premium Plus",
    "Tacoma Base",
    "Tacoma Double Cab",
    "Tacoma PreRunner",
    "Tacoma SR",
    ...
    "Thunderbird Premium",
    "Tiguan 2.0T SE",
    "Tiguan 2.0T SEL Premium R-Line",
    "Titan S",
    "Titan SE",
    "Titan SL",
    "Titan SV",
    ...
    "Trailblazer SS",
    "Transit Connect XL",
    "Transit Connect XL w/Rear Symmetrical Doors",
    "Transit Connect XLT",
    "Transit-250 Base",
    "Transit-350 Base",
    "Transit-350 XL",
    ...
    "Tundra 1794",
    "Tundra Grade",
    "Tundra Hybrid Capstone",
    "Tundra Hybrid Limited",
    "Tundra Hybrid TRD Pro",
    "Tundra Limited",
    "Tundra Platinum",
    "Tundra SR",
    "Tundra SR5",
    ...
    "Wrangler Sport",
    "Wrangler Unlimited",
    "Wrangler Unlimited 4xe Sahara",
    "Wrangler Unlimited Freedom Edition",
    ...
    "XC90 Hybrid T8 Inscription",
    "XC90 Hybrid T8 R-Design",
    "XC90 Recharge Plug-In Hybrid T8 Inscription 7 Passenger",
    "XC90 T6 Inscription",
    "XC90 T6 Momentum",
    "XE 20d Prestige",
    "XE 25t",
    ...
    "i8 Base",
    "tC Anniversary Edition",
    "tC Base",
    "tC Release Series 6.0",
    "xB Base",
]
